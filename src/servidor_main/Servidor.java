...
public class Servidor extends Thread {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            SSLServerSocket serverSocketSSL = Keystore.getServerSocketSSL();
            ...
            while (true) {
                SSLSocket socketSSL = (SSLSocket) serverSocketSSL.accept();
    ...
    public void run() {
        ...
        try {
            BufferedReader br = new BufferedReader(new InputStreamReader(serverSocketSSL.getInputStream()));
            PrintWriter pw = new PrintWriter(serverSocketSSL.getOutputStream(), true);
